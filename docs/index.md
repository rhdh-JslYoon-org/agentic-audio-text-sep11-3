...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/agentic-audio-text-sep11-3](https://github.com/rhdh-JslYoon-org/agentic-audio-text-sep11-3)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/agentic-audio-text-sep11-3-gitops](https://github.com/rhdh-JslYoon-org/agentic-audio-text-sep11-3-gitops)

# **Usage**

To access the agentic-audio-text-sep11-3 application that was deployed using the Software Template, complete the following instructions:
